...
SETTINGS: List[Setting] = [
    ...
    Setting("CANCEL_ECHO", "true", "bool", "Ignore own voice (echo cancel)",
            ...
            "Hearing & Voice"),
    Setting("INTERRUPT_ENABLED", "false", "bool", "Allow interrupting the AI",
            "ON = your speech stops the AI mid-response. OFF = speech is ignored while the AI is busy (default).",
            "Hearing & Voice"),
